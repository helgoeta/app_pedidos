...
from .views import HomeView, ClienteListView, ClienteDetailView, PedidoDetailView, PedidoListView, addPostPedido, addPostCliente, updatePostCliente, ProdutoListView, ProdutoDetailView, addPostProduto, updatePostProduto
...
urlpatterns = [
    ...
    path('produtos/<int:pk>/alterar', updatePostProduto.as_view(), name='altera-produto'),
