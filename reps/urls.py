...
from .views import HomeView, ClienteListView, ClienteDetailView, PedidoDetailView, PedidoListView, addPostPedido, addPostCliente, ProdutoListView, ProdutoDetailView, addPostProduto
